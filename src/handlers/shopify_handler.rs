use crate::{config::Config, db_conn::DbConn, models::shopify_connection, InstallQueryParams};
use std::sync::Arc;
...
//     */
//
//     let shop_results = shopify_connection::read_by_shop_and_nonce(&db_conn.get_conn(), params.shop, params.state);
//     let shop = shop_results.get(0).expect("No available shopify connection found");
//
